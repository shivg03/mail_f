...
type EmailAccountWithMailId = EmailAccount & { mail_Id: string; restriction_status?: string };
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600 mb-4">List Email Accounts</p>
            <p className="text-sm text-gray-500">
              This feature lets you create and manage email accounts. Want to
              learn more? Read our{" "}
              <a
                href="#"
                className="text-[#ffa184] hover:text-[#ff8c69] underline"
              >
                documentation <ExternalLink className="inline w-3 h-3" />
              </a>
            </p>
          </div>
          ...
          <div className="mb-4 flex items-center space-x-2">
            <div className="flex items-center space-x-2">
              <Button
                ...
                className="text-red-600 border-red-200 rounded-full hover:bg-red-50"
              >
            ...
            {currentAccounts.length === 0 ? (
              <div className="p-8 text-center">
                ...
                {!searchTerm && filterType === "All" && (
                  <Button
                    onClick={() => setLocation("/new-mail")}
                    className="bg-[#f98c6bd3] hover:bg-[#ff8c69] rounded-full text-sm text-white"
                    disabled={isLimitReached}
                  >
                        ...
                        <td className="p-4">
                          <div className="flex items-center space-x-2">
                            <Button
                              variant="outline"
                              size="sm"
                              className="text-[#ffa184] border-[#ffa184] hover:bg-[#ffa184] hover:text-white"
                              onClick={() => handleCheckEmail(account.mail_Id, account.id)}
                            >
